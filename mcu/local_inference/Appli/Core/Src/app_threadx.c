...
extern void my_thread_tcp(ULONG thread_input);
/* USER CODE END PFP */
...
UINT App_ThreadX_Init(VOID *memory_ptr)
{
  ...
  tx_thread_create(&my_thread, (char*)"tcp Thread",my_thread_tcp, 0x1234, thread_stack, 1024,3, 3, TX_NO_TIME_SLICE, TX_AUTO_START);
